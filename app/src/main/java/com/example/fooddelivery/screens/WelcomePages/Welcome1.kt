...
import com.example.fooddelivery.components.ButtonComponentWhite
...
import com.example.fooddelivery.components.NormaleTexteGrey
...
fun Welcome1 (navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            TitleTexte("Discover new tastes")
            Spacer(modifier = Modifier.height(5.dp))
            NormaleTexteGrey("Explore a world of flavors at your fingertips. Craving something delicious? We've got it covered!")

            Spacer(modifier = Modifier.weight(1f))
            ButtonComponent("Next",navController,"")
